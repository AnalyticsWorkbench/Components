package eu.sisob.api.visualization.format.datatable.fields;
...
public class DataField extends JSONObject {

	private static final long serialVersionUID = -6747068326779824959L;
	...
	public DataField(String id, String label) {
		super();
		super.put("id", id);
