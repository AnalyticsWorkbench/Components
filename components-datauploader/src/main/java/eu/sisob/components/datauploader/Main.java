...
//        AgentManager flm = new DataUploaderManager(new Tuple(String.class, Integer.class, Integer.class, String.class, "Data Uploader", String.class, String.class), "Data Uploader Manager", serverlocation, port);
//        flm.initialize();
